#!/usr/bin/env python3
"""OMNIX Project-Specific Tool — NOT a Jarvis core component.

This module is an optional adapter for the OMNIX project.
Jarvis does not require this module to function.

Original module: Jarvis OMNIX Workbench v1 — All-in-one local front door for OMNIX upgrade work.
...
# Import storage and Slack modules from new package location
from openjarvis.projects.omnix.omnix_storage import StorageManager, get_storage_manager
from openjarvis.projects.omnix.omnix_slack import SlackIntegration, get_slack_integration
